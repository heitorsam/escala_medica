<?php
    ...
    echo $cons_setor = "INSERT INTO escala_medica.SETOR (CD_SETOR, TP_SETOR, DS_SETOR, CD_PRESTADOR_MV, CD_USUARIO_CADASTRO, HR_CADASTRO)
                        VALUES($var_cd_produto, '$var_tipo', '$var_ds', $var_responsavel, '$usuario', SYSDATE)";
